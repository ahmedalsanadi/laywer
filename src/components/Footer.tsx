const Footer = () => {
  return (
    <footer className="bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-white py-12 overflow-x-hidden">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300 text-sm">
              مكتب متخصص في المحاماة والاستشارات القانونية بخبرة تزيد عن 15
              عامًا في مختلف مجالات القانون.
            </p>
          </div>
          ...
          <div>
            ...
            <address className="not-italic text-gray-600 dark:text-gray-300 text-sm space-y-2">
        ...
        <div className="border-t border-gray-300 dark:border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-500 dark:text-gray-400 text-sm">
            © {new Date().getFullYear()} جميع الحقوق محفوظة | مكتب المحامي أحمد
            اليوسفي
          </p>
        </div>
      </div>
